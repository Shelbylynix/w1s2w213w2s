...
Themes = {
    Cyberpunk = {
        ...
        ["Color Element Stroke"] = Color3.fromRGB(0, 150, 180)
    },
}, 
...
local SetProps, SetChildren, InsertTheme, Create do
	...
	pcall(Save, "cyberpunk library V1.json")
end
...
AddEle("Button", function(parent, props, ...)
	...
	Make("Stroke", New, {Color = Theme["Color Element Stroke"]})
	Make("Corner", New)
...
function redzlib:SetTheme(NewTheme)
	...
	SaveJson("cyberpunk library V1.json", redzlib.Save)
...
function redzlib:MakeWindow(Configs)
	local WTitle = Configs[1] or Configs.Name or Configs.Title or "Cyberpunk Hub"
	...
	ConnectSave(ControlSize1, function()
		if not Minimized then
			...
			SaveJson("cyberpunk library V5.json", redzlib.Save)
		end
	end)
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "Cyberpunk Hub",  
			Text = "Are you sure you want to close the hub?", 
			Options = {
				{"Yes", function()  
					ScreenGui:Destroy()
				end},
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddToggle(Configs)
			...
			Make("Stroke", ToggleHolder, {Color = Theme["Color Element Stroke"]})
		...
		function Tab:AddDropdown(Configs)
			...
			Make("Stroke", SelectedFrame, {Color = Theme["Color Element Stroke"]})
		...
		function Tab:AddSlider(Configs)
			...
			Make("Stroke", SliderBar, {Color = Theme["Color Element Stroke"]})
	...
	function Tab:AddDiscordInvite(Configs)
		...
		Make("Stroke", FrameHolder, {Color = Theme["Color Element Stroke"]})
		...
		local ImageLabel = Create("ImageLabel", FrameHolder, {
			...
			Image = Logo,
			BackgroundTransparency = 1
		}) Make("Corner", ImageLabel, UDim.new(0, 4)) Make("Stroke", ImageLabel, {Color = Theme["Color Element Stroke"]})
		...
		Make("Stroke", JoinButton, {Color = Theme["Color Element Stroke"]})
